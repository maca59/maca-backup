...
<section class="maca-bp-panel maca-bp-support">
	<h2><?php esc_html_e( 'Support', 'maca-backup-pro' ); ?></h2>
	<p class="maca-bp-muted">
		<?php esc_html_e( 'Send a support request to Maca Development. We reply to the email address below — you do not need to log in on maca.se.', 'maca-backup-pro' ); ?>
	</p>
	...
	<div class="maca-bp-support__grid">
		<div class="maca-bp-support__form-wrap">
			...
			<form id="maca-bp-support-form" class="maca-bp-support__form" method="post" action="" novalidate onsubmit="return false;">
				<table class="form-table" role="presentation">
					<tr>
						<th scope="row">
							<label for="maca-bp-support-name"><?php esc_html_e( 'Name', 'maca-backup-pro' ); ?></label>
						</th>
						<td>
					...
					<tr>
						<th scope="row">
							<label for="maca-bp-support-email"><?php esc_html_e( 'Email', 'maca-backup-pro' ); ?></label>
						</th>
						<td>
					...
					<tr>
						<th scope="row">
							<label for="maca-bp-support-site"><?php esc_html_e( 'Site URL', 'maca-backup-pro' ); ?></label>
						</th>
						<td>
					...
					<tr>
						<th scope="row">
							<label for="maca-bp-support-version"><?php esc_html_e( 'Plugin version', 'maca-backup-pro' ); ?></label>
						</th>
						<td>
					...
					<tr>
						<th scope="row">
							<label for="maca-bp-support-subject"><?php esc_html_e( 'Subject', 'maca-backup-pro' ); ?></label>
						</th>
						<td>
					...
					<tr>
						<th scope="row">
							<label for="maca-bp-support-body"><?php esc_html_e( 'Message', 'maca-backup-pro' ); ?></label>
						</th>
						<td>
							<textarea class="large-text" rows="8" id="maca-bp-support-body" name="maca_bp_support_message" required></textarea>
							<p class="description">
								<?php esc_html_e( 'Describe your issue or question as clearly as you can.', 'maca-backup-pro' ); ?>
							</p>
						</td>
					</tr>
					<tr>
						<th scope="row"><?php esc_html_e( 'System info', 'maca-backup-pro' ); ?></th>
						<td>
							<label>
								<input type="checkbox" id="maca-bp-support-include-info" name="maca_bp_support_include_info" value="1" checked />
								<?php esc_html_e( 'Attach site URL, plugin version, WordPress and PHP versions (recommended)', 'maca-backup-pro' ); ?>
							</label>
						</td>
					</tr>
				</table>
				...
				<p class="submit">
					<button type="button" class="button button-primary" id="maca-bp-support-submit">
						<?php esc_html_e( 'Send request', 'maca-backup-pro' ); ?>
					</button>
				</p>
		...
		<aside class="maca-bp-support__aside">
			<h3><?php esc_html_e( 'More help', 'maca-backup-pro' ); ?></h3>
			<ul>
				<li>
				...
				<li>
					<a href="<?php echo esc_url( $product_url ); ?>" target="_blank" rel="noopener noreferrer">
						<?php esc_html_e( 'Product page (maca.se)', 'maca-backup-pro' ); ?>
					</a>
				</li>
			</ul>

			<div class="maca-bp-support__tips">
				<h3><?php esc_html_e( 'Before you write', 'maca-backup-pro' ); ?></h3>
				<ul>
					<li><?php esc_html_e( 'Note the plugin version (prefilled above) and your WordPress / PHP versions.', 'maca-backup-pro' ); ?></li>
					<li><?php esc_html_e( 'Describe what you tried (full / database / files backup, restore, Smart Restore, storage provider).', 'maca-backup-pro' ); ?></li>
					<li><?php esc_html_e( 'Include any error text from the Logs tab or the progress panel.', 'maca-backup-pro' ); ?></li>
					<li><?php esc_html_e( 'Confirm remote storage credentials only if relevant — never paste secret keys into tickets if avoidable.', 'maca-backup-pro' ); ?></li>
				</ul>
			</div>
		</aside>
	</div>
...
<section class="maca-bp-panel maca-bp-legal" id="maca-bp-privacy">
	<div class="maca-bp-panel__head">
		<h2><?php esc_html_e( 'Privacy Policy', 'maca-backup-pro' ); ?></h2>
...
<section class="maca-bp-panel maca-bp-legal-accept" id="maca-bp-accept">
	<h2><?php esc_html_e( 'Accept terms & privacy', 'maca-backup-pro' ); ?></h2>
		...
		<div class="notice notice-success inline maca-bp-legal-accept__status">
			<p>
				...
				$user_label = ! empty( $acceptance['user_login'] )
					...
					: __( 'Unknown user', 'maca-backup-pro' );
				printf(
					/* translators: 1: datetime, 2: username, 3: terms version, 4: privacy version */
					esc_html__( 'Accepted %1$s by %2$s (terms %3$s / privacy %4$s).', 'maca-backup-pro' ),
	...
	<?php else : ?>
		<div class="notice notice-warning inline maca-bp-legal-accept__status">
			<p><?php esc_html_e( 'Backup and restore are paused until you accept both documents below.', 'maca-backup-pro' ); ?></p>
		</div>
	<?php endif; ?>
		...
		<form method="post" class="maca-bp-legal-accept__form">
			...
			<label class="maca-bp-legal-accept__check">
				...
				<span>
					...
					$terms_label = __( 'I have read and accept the <a href="%s">Terms of Use</a>.', 'maca-backup-pro' );
					printf(
						wp_kses(
							$terms_label,
							array(
			...
			<label class="maca-bp-legal-accept__check">
				...
				<span>
					...
					$privacy_label = __( 'I have read and accept the <a href="%s">Privacy Policy</a>.', 'maca-backup-pro' );
					printf(
						wp_kses(
							$privacy_label,
							array(
			...
			<?php submit_button( __( 'Accept and continue', 'maca-backup-pro' ), 'primary', 'submit', false ); ?>
		</form>
	<?php endif; ?>
</section>
