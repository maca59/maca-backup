	...
	public function enqueue( string $hook ): void {
		...
		wp_localize_script(
			...
			array(
				...
				'migrateUrl'    => esc_url_raw( Maca_Backup_Pro_Admin::tab_url( 'migrate' ) ),
				...
				'i18n'          => array(
					...
					'confirmMigrate' => __( 'Migrate will overwrite this site’s files and database with the selected backup, rewrite URLs to this host, and keep your current admin login. Continue?', 'maca-backup' ),
					...
					'importStepMigrate' => __( 'Migrate to this host', 'maca-backup' ),
					'importStepMigrateHelp' => __( 'This replaces this site with the imported archive, rewrites URLs here, and keeps your current admin login.', 'maca-backup' ),
					'importBtnNext'    => __( 'Next', 'maca-backup' ),
					'importBtnLater'   => __( 'Later', 'maca-backup' ),
					'importBtnContinue'=> __( 'Continue to restore', 'maca-backup' ),
					'importBtnContinueMigrate'=> __( 'Continue to migrate', 'maca-backup' ),
					...
					'importBtnMigrate' => __( 'Migrate now', 'maca-backup' ),
